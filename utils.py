...
def loadingimages(image, who, cellsize):
    ...
    if who == 'player':
        ...
        cd = [ss.image_at((90, 184, cellsize*5, cellsize*4)),0,0,0,0,ss.image_at((211, 22, cellsize*5, cellsize*4))]
        cr = [ss.image_at((90, 104, cellsize*5, cellsize*5)),0,0,0,0,ss.image_at((210, 264, cellsize*5, cellsize*5))]
        cl = [ss.image_at((90, 264, cellsize*5, cellsize*5)),0,0,0,0,ss.image_at((210, 104, cellsize*5, cellsize*5))]
        cu = [ss.image_at((91, 22, cellsize*5, cellsize*4)),0,0,0,0,ss.image_at((210, 184, cellsize*5, cellsize*4))]
        #cdr = 
        #cdl = 
        #cur = 
        #cul =  
